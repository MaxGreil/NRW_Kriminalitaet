...
Hovering the mouse over the cities marked via blue circles reveal the selected numbers for this city.

```{r, out.width = "100%", echo = FALSE}
knitr::include_graphics('man/figures/UI2.png')
```

Additionally, basic statistics for the selected crime and year are desplayed below the map.
